...
while cap.isOpened():
    ...
    if not ret:
        break
    frames.append(cv2.resize(frame, (128, 128)))  # Resize for efficiency
...
fps = 10 # Frames per second for the summarized video
...
output_video_path = f'Videos/summarized_video_{desired_duration}sec_fps{fps}(128X128).mp4'
frame_size = (128, 128)
